...
import { UpdateImagesForm } from '../forms/UpdateImagesForm'

function UpdateAccoutImages() 
{
    ...
    useEffect(() =>
    {
      ...
      {
        setMsg("Please login to update your account images")
      }
      else
      {
        setMsg("")
          ...
          <div className="w-full lg:w-[70%] mx-auto">
            ...
            
            {
              ...
              <div>
                ...
                coverImage={currentUser.userData?.coverImage}
                />
              </div>
            }
            ...
            ">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-1 leading-5">
                    Make sure your images are appropriate.
                  </p>
                </div>
